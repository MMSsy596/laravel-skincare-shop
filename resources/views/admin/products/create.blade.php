        ...
        <div class="col-lg-10">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">
                        <i class="fas fa-plus me-2"></i>Thêm sản phẩm mỹ phẩm mới
                    </h4>
                </div>
                    ...
                    <form method="POST" action="{{ route('admin.products.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="skin_type" name="skin_type">
                                    ...
                                    @foreach(\App\Models\Product::SKIN_TYPES as $key => $name)
                                        <option value="{{ $key }}" {{ old('skin_type') == $key ? 'selected' : '' }}>
                                            {{ $name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="age_group" name="age_group">
                                    @foreach(\App\Models\Product::AGE_GROUPS as $key => $name)
                                        <option value="{{ $key }}" {{ old('age_group', 'all') == $key ? 'selected' : '' }}>
                                            {{ $name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea class="form-control" id="ingredients" name="ingredients" rows="3" placeholder="Liệt kê các thành phần chính của sản phẩm...">{{ old('ingredients') }}</textarea>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea class="form-control" id="usage_instructions" name="usage_instructions" rows="3" placeholder="Hướng dẫn cách sử dụng sản phẩm...">{{ old('usage_instructions') }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="weight" name="weight" value="{{ old('weight') }}" placeholder="Ví dụ: 30ml, 50g">
                            </div>
                            
                            <div class="col-md-4">
                                <label for="dimensions" class="form-label fw-semibold">Kích thước</label>
                                <input type="text" class="form-control" id="dimensions" name="dimensions" value="{{ old('dimensions') }}" placeholder="Ví dụ: 5x5x10cm">
                            </div>
                            
                            <div class="col-md-4">
                                <label for="shelf_life" class="form-label fw-semibold">Hạn sử dụng</label>
                                <input type="text" class="form-control" id="shelf_life" name="shelf_life" value="{{ old('shelf_life') }}" placeholder="Ví dụ: 24 tháng">
                            </div>
                        </div>
